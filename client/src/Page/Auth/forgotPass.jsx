...
import { UserFI, UserShield } from "../../utils/SVG/SVG";
                ...
                <form action="" onSubmit={(e)=>{e.preventDefault(); submitDebouce}}>
                    <LogoCom/>
                        ...
                        <div className="inputDiv">
                            ...
                            <label htmlFor="USEmail"><UserFI/> <span className="font-normal text-sm">Email OR userName</span></label>
                        </div>
                        <div className={`inputDiv ${isFinding.isFindst ? "" : "pointer-events-none"}`}>
                            ...
                            <label htmlFor="e_mail"><UserShield /> <span className="font-normal text-sm">{isFinding.whatTo || ""}</span></label>
                        </div>
