    ...
    return(
        ...
        ">
            <div className="leftHeader text-4xl flex flex-1 gap-4 pl-5">
                <div className="h-10 w-10 flex items-center justify-center text-3xl border-gray-500 border rounded-full"><i className="bx bx-menu text-skin-ptext"></i></div>
                <i className="bx bx-code-block transition-all duration-500
                ease-in-out bg-size-[200%_200%] bg-linear-to-br from-purple-500 via-pink-400 to-blue-600 
