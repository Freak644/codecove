...
import { SendSvg } from "../../../utils/SVG/menuSVG";
...
export default function UploadController() {
    ...
    return(
        <div className="underTaker flex-wrap no-copy">
                ...
                <div className="rightsideDiv gap-3.5!">
                    {progress> 0 && <div className="wrapper h-40 w-40 rounded-full relative overflow-hidden border border-skin-ptext/50">
                        <div style={{
                                ...
                                }} className={`progressBar h-full w-full rounded-full flex items-center justify-center animate-pulse transition-all duration-700`}>
